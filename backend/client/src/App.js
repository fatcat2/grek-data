  	...
  	<div className="App">
  		<MuiThemeProvider theme={theme}>
			...
			<Grid
				...
				justify="center"
			>
				<Grid item lg={10} md={4} s={6} xs={12} >
							<MaterialTable
